...
import type { SkillCategory as SkillCategoryData } from "shared";
import styles from "@/app/skills/skills.module.scss";
...
export function SkillsContent({ skills }: { skills: SkillCategoryData[] }) {
